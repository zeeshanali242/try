...
package object globals {
  ...
  val currencies = List(
    ...
    "ether" -> Wallet.CryptoCurrency.ETH,
    "bitcoincash" -> Wallet.CryptoCurrency.BCH,
    "dash" -> Wallet.CryptoCurrency.DASH,
    "zcash" -> Wallet.CryptoCurrency.ZEC
...
object Global extends GlobalSettings {
  ...
  override def onStart(app: Application) {
    ...
    trynexUserService.onStart()
  }

  override def onStop(app: Application) {
    Logger.info("Application shutdown...")
    trynexUserService.onStop()
  }
}
